...
Y$notes = NULL
Y2016 =Y%>%filter(Year==2016)%>%group_by(region,Medal)%>%summarize(total=n())%>%arrange(desc(total))%>%head(n=30)
ggplot(Y2016,aes(region,total,fill=Medal)) +
     ...
     ggtitle("Top Team medal winners ", subtitle = "Summer Olympics 2016(Female)") 
```
...
>>>>>>> 707eec2be7ee9892c304f7fc164bee64f1b64f2d
```
